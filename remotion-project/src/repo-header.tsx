    ...
    >
      <div className="flex-auto min-width-0 width-fit mr-3">
        ...
        >
          ...
          <span className="author flex-self-stretch url fn" itemProp="author" style={{ color: "#ffffff" }}>
            <a className="" rel="author" style={{ color: "#ffffff", textDecoration: "none" }}>
              {org}
            </a>
          </span>
          <span className="mx-1 flex-self-stretch" style={{ color: "#95a5a6" }}>/</span>
          <a
            itemProp="name"
        ...
        <li>
          <div className="d-block js-toggler-container js-social-container starring-container ">
            <div className="unstarred">
              <div className="btn btn-sm btn-with-count" style={{
                ...
                <span data-view-component="true">Fed Up</span>
              </div>{" "}
              <a
